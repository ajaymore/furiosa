 ...
 */
function initApolloClient(initialState: any, ctx: any) {
 ...
 * @param  {Object} [initialState={}]
 */
function createApolloClient(initialState = {}, ctx: any) {
  const httpLink = new HttpLink({
    uri: ctx && ctx.req ? `http://localhost:3000/api/graphql` : `/api/graphql`, // Server URL (must be absolute)
